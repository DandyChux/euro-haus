	...
	export const badgeVariants = tv({
		...
		variants: {
			variant: {
				...
				light: "bg-background text-foreground hover:bg-accent hover:text-accent-foreground",
				accent: "bg-accent text-accent-foreground [a]:hover:bg-accent/80",
				circle: "px-3 py-1 rounded-full border-border bg-transparent text-foreground hover:border-primary hover:text-primary",
			},
		},
		defaultVariants: {
			variant: "default",
