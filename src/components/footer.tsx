			...
			<div className="px-4 md:px-6">
				<div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
					<div>
						...
						<p className="mt-2 text-sm text-muted-foreground">Building a community around car enthusiasm since 2023.</p>
						<div className="mt-4 flex space-x-3">
							<a href="https://instagram.com/theeurohaus" className="text-muted-foreground hover:text-primary">
							...
							<a href="https://youtube.com/@TheEuroHaus" className="text-muted-foreground hover:text-primary">
